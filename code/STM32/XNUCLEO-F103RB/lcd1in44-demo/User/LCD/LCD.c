...
void LCD_SetGramScanWay(LCD_SCAN_DIR Scan_dir){		
	...
	LCD_WriteData_8Bit( MemoryAccessReg_Data & 0xf7 | 0x08);	//RGB color filter panel
#endif
...
void LCD_Clear(COLOR  Color){
	LCD_SetArealColor(0,0, LCD_X_MAXPIXEL , LCD_Y_MAXPIXEL  , Color);	
}
...
//	LCD_DrawLine(0, sLCD_DIS.LCD_Dis_Page - 20, sLCD_DIS.LCD_Dis_Column, sLCD_DIS.LCD_Dis_Page - 20, RED,LINE_DOTTED, DOT_PIXEL_DFT);
	...
	LCD_DrawRectangle(0,0,128,8,BLUE, DRAW_FULL, DOT_PIXEL_1X1);
	LCD_DrawRectangle(1,1,128,128,RED,DRAW_EMPTY,DOT_PIXEL_2X2);
	...
	LCD_DisplayString(28,45,"1.44inch TFTLCD",&Font8,RED,GRED);
